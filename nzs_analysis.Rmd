...
```{r}
funPlot <- function(full_df, Bname) {
...
wrapPlots <- function(r1, permList_zs, permList_nzs, ran_title = "RaR") {
  ...
  plotList <- lapply(all_B, FUN = funPlot, full_df = full_df)
  ...
  # Save PDFs
  pdf(paste("plots/summary_", ran_title, "_", r1, "_1.pdf", sep = ""), height = 10, width = 20)
  print(wrap_plots(subList1, ncol = 5))
  dev.off()
  
  pdf(paste("plots/summary_", ran_title, "_", r1, "_2.pdf", sep = ""), height = 10, width = 20)
...
lapply(setNames, function(x) {wrapPlots(r1 = x, permList_zs_RaR, permList_nzs_RaR, ran_title = "RaR")})
